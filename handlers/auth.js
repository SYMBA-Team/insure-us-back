...
export const Signup = (User) => async (req, res, next) => {
    try {
...
export const SignIn = (User) => async (req, res, next) => {
    try {
...
export const Recover = (User) => async (req, res) => {
    try {
...
export const Reset = (User) => async (req, res) => {
    try {
